...
The data is augmented by applying random rotations, zooms and random contrast enhancements to the images by means of a
custom-built function that uses keras layers.
