...
This python script evaluates the performance of a RandomForest classifier and a Support Vector Machine classifier on the
feature extracted from the diffusion tensor.
The subjects are divided in two groups: AD and CN. Corresponding to subjects affected with Alzheimer's disease and
control subjects respectively.
As an option, the user can choose to perform a Principal Component Analysis (PCA) on the Random Forest classifier. and a
feature reduction on the Support Vector Machine classifier.
